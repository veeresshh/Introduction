...
public class SeleniumTJavaStreamsA {
	...
	public static void main(String[] args) {
		...
		System.out
				.println(Stream.of("Alan", "Daniel", "Alexa", "Anthony", "Ram").filter(V -> V.startsWith("A")).count());
		...
		List<String> UpdatedList = Names.stream().filter(S -> S.endsWith("a")).map(S -> S.toUpperCase())
